import random  # Fungsi: generate angka acak
import datetime  # Fungsi: manipulasi tanggal dan waktu
...
def main():
    ...
    while True:  # Struktur kontrol: perulangan while
        print("\nMenu:")
        ...
        if pilihan == "1":
            ...
            try:
                # Menggunakan library datetime untuk parsing tanggal
                tanggal_deadline = datetime.datetime.strptime(deadline, "%d-%m-%Y").date()
                id_tugas = random.randint(1000, 9999)  # ID unik untuk tugas
            ...
            if daftar_tugas:
                # Menggunakan library random untuk memilih tugas acak
